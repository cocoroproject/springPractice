      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#">스터디</a></li>
            <li><a href='<%=realPath%>/layout/mainLayout.jsp?body=../page/Join/JoinForm.jsp'>회원가입</a></li>
            <li class="dropdown">
            ...
            <li><a href='<%=realPath%>/layout/mainLayout.jsp?body=../page/Join/LoginForm.jsp'>로그인</a></li>
          </ul>
        </div>
      </div>
    </nav>
